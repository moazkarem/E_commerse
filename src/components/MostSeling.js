...
import { getMostselling } from "../store/BestDetailsSlice";
...
const MostSeling = () => {
  const { loading, MostSeling } = useSelector((state) => state.BestDetail);
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(getMostselling());
  }, [dispatch]);
  return (
    <div>
